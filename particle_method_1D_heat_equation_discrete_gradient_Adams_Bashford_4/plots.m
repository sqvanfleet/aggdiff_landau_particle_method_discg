...
print(f,'1D_heat_eq_AB_4_error.pdf','-dpdf','-r0')
...
pos = get(f,'Position');
set(f,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)])
print(f,'1D_heat_eq_AB_4_entropy.pdf','-dpdf','-r0')
...
pos = get(f,'Position');
set(f,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)])
print(f,'1D_heat_eq_AB_4_ROC.pdf','-dpdf','-r0')
...
pos = get(f,'Position');
set(f,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)])
print(f,'1D_heat_eq_AB_4_iter.pdf','-dpdf','-r0')
