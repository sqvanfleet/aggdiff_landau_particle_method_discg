...
print(f,'1D_heat_eq_AB_2_error.pdf','-dpdf','-r0')
...
xlabel('$t$','Interpreter','latex')
ylabel('$E^{\varepsilon}_{A}(f^N)$','Interpreter','latex')
...
pos = get(f,'Position');
set(f,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)])
print(f,'1D_heat_eq_AB_2_entropy.pdf','-dpdf','-r0')
...
pos = get(f,'Position');
set(f,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)])
print(f,'1D_heat_eq_AB_2_ROC.pdf','-dpdf','-r0')
...
pos = get(f,'Position');
set(f,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)])
print(f,'1D_heat_eq_AB_2_iter.pdf','-dpdf','-r0')
...
%     'DisplayName',['M = ',num2str(n(1))])
% hold on
% scatter(error_list_60(:,1),error_list_60(:,7),...
%     'DisplayName',['M = ',num2str(n(2))])
% hold on 
