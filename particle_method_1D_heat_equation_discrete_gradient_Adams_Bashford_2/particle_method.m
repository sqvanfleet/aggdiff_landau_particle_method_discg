...
Adams_Bash_points = zeros(2,length(x));
...
%     drawnow
    ...
    %Switch to 2nd order Adams Bashford method

    if nt > 2.5

    Adams_bash_switch(2) = Adams_bash_switch(2) + 1;

    %initial guess second order Adams Bashford
    ...
    %Second order Adams Bashford update
    x_new = x - dt*(1.5*F_2 - .5*F_1);
