...
figure 
semilogy(error_list_1(:,1),abs(error_list_1(:,5)-E0_1),'-o','LineWidth',2,'MarkerIndices',...
    round(linspace(1,Nt_1,10)),......
    'DisplayName',['$M = $ ',num2str(n_1)])
hold on 
semilogy(error_list_2(:,1),abs(error_list_2(:,5)-E0_2),'-*','LineWidth',2,'MarkerIndices',...
    round(linspace(1,Nt_2,10)),......
    'DisplayName',['$M = $ ',num2str(n_2)])
hold on 
semilogy(error_list_3(:,1),abs(error_list_3(:,5)-E0_3),'-square','LineWidth',2,'MarkerIndices',...
    round(linspace(1,Nt_3,10)),......
    'DisplayName',['$M = $ ',num2str(n_3)])
hold on 
semilogy(error_list_4(:,1),abs(error_list_4(:,5)-E0_4),'-+','LineWidth',2,'MarkerIndices',...
    round(linspace(1,Nt_4,10)),......
    'DisplayName',['$M = $ ',num2str(n_4)])
hold on 
semilogy(error_list_5(:,1),abs(error_list_5(:,5)-E0_5),'-diamond','LineWidth',2,'MarkerIndices',...
...
hold off
xlabel('$t$','Interpreter','latex')
ylabel('$E^{\varepsilon}_{L}$','Interpreter','latex')
...
hold off
xlabel('$t$','Interpreter','latex')
ylabel('$-D^{\varepsilon}$','Interpreter','latex')
...
figure
semilogy(error_list_1(:,1),abs(error_list_1(:,3)-Mx0_1),'-o','LineWidth',2,'MarkerIndices',...
    round(linspace(1,Nt_1,10)),...
    'DisplayName',['$M = $ ',num2str(n_1)])
hold on
semilogy(error_list_2(:,1),abs(error_list_2(:,3)-Mx0_2),'-*','LineWidth',2,'MarkerIndices',...
    round(linspace(1,Nt_2,10)),...
    'DisplayName',['$M = $ ',num2str(n_2)])
hold on
semilogy(error_list_3(:,1),abs(error_list_3(:,3)-Mx0_3),'-square','LineWidth',2,'MarkerIndices',...
    round(linspace(1,Nt_3,10)),...
    'DisplayName',['$M = $ ',num2str(n_3)])
hold on
semilogy(error_list_4(:,1),abs(error_list_4(:,3)-Mx0_4),'-+','LineWidth',2,'MarkerIndices',...
    round(linspace(1,Nt_4,10)),...
    'DisplayName',['$M = $ ',num2str(n_4)])
hold on
semilogy(error_list_5(:,1),abs(error_list_5(:,3)-Mx0_5),'-diamond','LineWidth',2,'MarkerIndices',...
    round(linspace(1,Nt_5,10)),...
    'DisplayName',['$M = $ ',num2str(n_5)])
hold off
xlabel('$t$','Interpreter','latex')
ylabel('$|P_x - P_x^0|$','Interpreter','latex')
axis([0 5 10e-16 10e-14])
title('Momentum $x$ Direction Evolution','Interpreter','latex')
hl = legend('show');
set(hl,'Location','northeast')
set(hl,'Interpreter','latex')
f = gcf;
...
figure
semilogy(error_list_1(:,1),abs(error_list_1(:,4)-My0_1),'-o','LineWidth',2,'MarkerIndices',...
    round(linspace(1,Nt_1,10)),...
    'DisplayName',['$M = $ ',num2str(n_1)])
hold on
semilogy(error_list_2(:,1),abs(error_list_2(:,4)-My0_2),'-*','LineWidth',2,'MarkerIndices',...
    round(linspace(1,Nt_2,10)),...
    'DisplayName',['$M = $ ',num2str(n_2)])
hold on
semilogy(error_list_3(:,1),abs(error_list_3(:,4)-My0_3),'-square','LineWidth',2,'MarkerIndices',...
    round(linspace(1,Nt_3,10)),...
    'DisplayName',['$M = $ ',num2str(n_3)])
hold on
semilogy(error_list_4(:,1),abs(error_list_4(:,4)-My0_4),'-+','LineWidth',2,'MarkerIndices',...
    round(linspace(1,Nt_4,10)),...
    'DisplayName',['$M = $ ',num2str(n_4)])
hold on
semilogy(error_list_5(:,1),abs(error_list_5(:,4)-My0_5),'-diamond','LineWidth',2,'MarkerIndices',...
    round(linspace(1,Nt_5,10)),...
    'DisplayName',['$M = $ ',num2str(n_5)])
hold off
xlabel('$t$','Interpreter','latex')
ylabel('$|P_y-P_y^0|$','Interpreter','latex')
title('Momentum $y$ Direction Evolution','Interpreter','latex')
hl = legend('show');
set(hl,'Location','northeast')
set(hl,'Interpreter','latex')
f = gcf;
