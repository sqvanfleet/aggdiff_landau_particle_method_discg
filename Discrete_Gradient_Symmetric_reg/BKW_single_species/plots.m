...
figure 
plot(error_list_1(:,1),error_list_1(:,8)-E0_1,'-o','LineWidth',2,'MarkerIndices',...
    round(linspace(1,Nt_1,10)),......
    'DisplayName',['M = ',num2str(n_1)])
hold on 
plot(error_list_2(:,1),error_list_2(:,8)-E0_2,'-*','LineWidth',2,'MarkerIndices',...
    round(linspace(1,Nt_2,10)),......
    'DisplayName',['M = ',num2str(n_2)])
hold on 
plot(error_list_3(:,1),error_list_3(:,8)-E0_3,'-square','LineWidth',2,'MarkerIndices',...
    round(linspace(1,Nt_3,10)),......
    'DisplayName',['M = ',num2str(n_3)])
hold on 
plot(error_list_4(:,1),error_list_4(:,8)-E0_4,'-+','LineWidth',2,'MarkerIndices',...
    round(linspace(1,Nt_4,10)),......
    'DisplayName',['M = ',num2str(n_4)])
hold on 
plot(error_list_5(:,1),error_list_5(:,8)-E0_5,'-diamond','LineWidth',2,'MarkerIndices',...
    round(linspace(1,Nt_5,10)),......
    'DisplayName',['M = ',num2str(n_5)])
hold off
xlabel('$t$','Interpreter','latex')
ylabel('Kinetic Energy','Interpreter','latex')
title('Kinertic Energy Evolution','Interpreter','latex')
hl = legend('show');
...
hold off
xlabel('$t$','Interpreter','latex')
ylabel('$E^{\varepsilon}_L[f^N]$','Interpreter','latex')
...
plot(-log(h_list),-L2_roc(2)*log(h_list)-L2_roc(1),'-o','LineWidth',2,'DisplayName',...
    ['$L^2$ order $=$ ',num2str(L2_roc(2))])
hold on
plot(-log(h_list),-L1_roc(2)*log(h_list)-L1_roc(1),'-*','LineWidth',2,'DisplayName',...
    ['$L^1$ order $=$ ',num2str(L1_roc(2))])
hold on
plot(-log(h_list),-Linf_roc(2)*log(h_list)-Linf_roc(1),'-square','LineWidth',2,'DisplayName',...
    ['$L^{\infty}$ order $=$ ',num2str(Linf_roc(2))])
hold on
plot(-log(h_list),-2*log(h_list),'--','DisplayName','Reference Slope = 2')
